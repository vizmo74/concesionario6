...
class VentaResourceIT {
    ...
    public static Venta createEntity(EntityManager em) {
        Venta venta = new Venta().descuento(DEFAULT_DESCUENTO).impuesto(DEFAULT_IMPUESTO).total(DEFAULT_TOTAL).fecha(DEFAULT_FECHA);
        return venta;
    }
    ...
    public static Venta createUpdatedEntity(EntityManager em) {
        Venta venta = new Venta().descuento(UPDATED_DESCUENTO).impuesto(UPDATED_IMPUESTO).total(UPDATED_TOTAL).fecha(UPDATED_FECHA);
        return venta;
    }
    ...
    void createVenta() throws Exception {
        ...
        assertThat(testVenta.getDescuento()).isEqualTo(DEFAULT_DESCUENTO);
    ...
    void putExistingVenta() throws Exception {
        ...
        updatedVenta.descuento(UPDATED_DESCUENTO).impuesto(UPDATED_IMPUESTO).total(UPDATED_TOTAL).fecha(UPDATED_FECHA);
        ...
        Venta testVenta = ventaList.get(ventaList.size() - 1);
        assertThat(testVenta.getDescuento()).isEqualTo(UPDATED_DESCUENTO);
    ...
    void partialUpdateVentaWithPatch() throws Exception {
        ...
        partialUpdatedVenta.impuesto(UPDATED_IMPUESTO).fecha(UPDATED_FECHA);
    ...
    void fullUpdateVentaWithPatch() throws Exception {
        ...
        partialUpdatedVenta.descuento(UPDATED_DESCUENTO).impuesto(UPDATED_IMPUESTO).total(UPDATED_TOTAL).fecha(UPDATED_FECHA);
